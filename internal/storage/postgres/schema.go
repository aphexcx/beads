...
CREATE TABLE IF NOT EXISTS linear_label_snapshots (
    ...
    CONSTRAINT fk_linear_label_snapshots_issue FOREIGN KEY (issue_id) REFERENCES issues (id) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS idx_linear_label_snapshots_issue ON linear_label_snapshots (issue_id);
`
