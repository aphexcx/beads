...
func TestSchemaAfterInit(t *testing.T) {
	...
	// Linear sync snapshot tables: linear_label_snapshots via main migration
	// 0051, linear_issue_snapshots / linear_project_snapshots via ignored
	// migrations 0010/0011 (dolt-ignored, registered in 0052).
